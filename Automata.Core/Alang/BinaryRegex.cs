...
public abstract class BinaryRegex : AlangRegex
{
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="BinaryRegex"/> class with the specified left and right operands.
    /// </summary>
    ...
    public BinaryRegex(AlangRegex left, AlangRegex right) : base()
    {
        Left = left;
        Right = right;
    }
