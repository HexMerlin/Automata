...
/// </remarks>
public class SymbolicTransitions : Transitions<SymbolicTransition>
{
    ///<inheritdoc/>
    public SymbolicTransitions() : base() { }

    ///<inheritdoc/>
    public SymbolicTransitions(IEnumerable<SymbolicTransition> initialTransitions) : base(initialTransitions) { }
